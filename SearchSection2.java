...
public class SearchSection2 {
	...
	public static void main(String[] args) throws IOException {
        ...
        for (Data.Page page : DeserializeData.iterableAnnotations(fileInputStream3)) {
            ...
            int searchRank=0;
            String queryId = null;
            List<PageSkeleton> squeryId = page.getSkeleton(); // New Added
            for (List<Data.Section> sectionPath : page.flatSectionPaths()) {
            	
                //queryId = Data.sectionPathId(page.getPageName(), sectionPath); //changed getPageId to getPageName
                queryId = Data.sectionPathId(page.getPageId(), sectionPath); //changed getPageId to getPageName
                ...
                for (int i = 0; i < scoreDoc.length; i++) {
                    ...
                    writer.write(queryId+" Q0 "+paragraphid+ss+" "+searchRank + " "+searchScore+" Lucene-BM25\n");
                    count ++;
            ...
            //writer.write(queryId+" Q0 "+paragraphid+ sb +" "+searchRank + " "+searchScore+" Lucene-BM25\n");
            // ***END***
